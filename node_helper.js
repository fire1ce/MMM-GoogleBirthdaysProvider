...
module.exports = NodeHelper.create({
    ...
    ical: icalGenerator({
        name: 'MMM-GoogleBirthdaysProvider2',
        domain: 'mmm-googlebirthdaysprovider2.local'
    }),
    ...
    _createIcalEvents: function(birthdays) {
        birthdays.forEach(person => {
            ...
            this.ical.createEvent({
                start: date,
                repeating: person.birthday.year
                    ? { freq: 'YEARLY' }
                    : undefined, // repeat yearly if a year is set
                summary: `${person.name}`,
                allDay: true
            });
        });
